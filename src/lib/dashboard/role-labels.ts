...
// roles foi preservada). "Direção" fica em âmbar, entre o violeta de Super Admin e
// o azul de Gestor na hierarquia visual. Não trocar sem atualizar as duas junto.
export const ROLE_BADGE_CLASS: Record<UserRole, string> = {
  ...
  direcao: 'bg-amber-50 text-amber-700 dark:bg-amber-500/10 dark:text-amber-400',
