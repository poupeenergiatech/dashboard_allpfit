...
import { GestoresPodium, PodiumFunnelConnector } from '@/components/dashboard/gestores-podium'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 items-start gap-3 lg:grid-cols-[1fr_auto_1fr_auto_1fr] lg:gap-4">
        ...
        <PodiumFunnelConnector />
        <GestoresPodium rows={MOCK_GESTORES_PANEL.rows} metricKey="clientesAlleAtivos" />
      </div>
