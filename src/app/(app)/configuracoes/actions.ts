...
// Disparo manual (botão em /configuracoes) do sync — ver runAlleDocumentosSync
// pra lógica de matching e o endpoint /api/sync-alle-documentos pro disparo automático
// via cron. Os dois gravam em alle_documentos_sync_log (fetchSyncHistory), então o
// histórico da tela cobre as duas origens.
