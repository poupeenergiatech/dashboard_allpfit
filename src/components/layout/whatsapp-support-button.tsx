...
// (ver AppLayout) — mesmo padrão de "fale conosco" que outros sistemas já usam.
// z-30: fica abaixo do overlay do menu mobile (Sidebar, z-40) e do toast (z-50),
...
export function WhatsappSupportButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition hover:scale-105 hover:bg-[#20bd5a] active:scale-95"
    >
