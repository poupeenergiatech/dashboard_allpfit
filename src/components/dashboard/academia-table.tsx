          ...
          {rows.map((row) => {
            ...
            return (
              <tr key={row.academiaId} className="border-b border-slate-50 transition last:border-0 hover:bg-slate-50/70">
                ...
                <td className="px-4 py-3 text-right tabular-nums text-slate-600">{row.totalContatos}</td>
                <td className="px-4 py-3 text-right tabular-nums text-slate-600">{row.totalConversoes}</td>
                <td className="px-4 py-3">
